...
Last observed result: **31 passed, 2 warnings** (2026-09-23, Windows 11, Python 3.13.5). The tests cover the insider parser, enrichment and scorers only. CI ([.github/workflows/ci.yml](.github/workflows/ci.yml)) also runs `pyflakes src/ tests/` and `pip-audit --strict`.
