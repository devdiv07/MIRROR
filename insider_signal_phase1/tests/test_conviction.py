...
from scoring.conviction import score_conviction
...
def test_aggregator_uses_registry():
    ...
    from scoring.registry import assert_all_registered, SCORER_REGISTRY
...
def test_aggregator_clamps_individual_scorer_output():
    ...
    from scoring.registry import register_scorer, SCORER_REGISTRY
